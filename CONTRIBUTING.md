...
# Contributing to Mojo Code

Mojo Code is a community-driven project, and we deeply value every contribution. To streamline collaboration, we operate on an [Issue-First](#issue-first-approach) basis, meaning all [Pull Requests (PRs)](#submitting-a-pull-request) must first be linked to a GitHub Issue. Please review this guide carefully.
...
### 3. Join the Mojo Code Community

- **Primary:** Join our [Discord](https://discord.gg/Mojocode) and DM **Hannes Rudolph (`hrudolph`)**.
- **Alternative:** Experienced contributors can engage directly via [GitHub Projects](https://github.com/orgs/MojoCodeInc/projects/1).
...
- **Check existing issues**: Search [GitHub Issues](https://github.com/MojoCodeInc/Mojo-Code/issues).
...
- Check the [GitHub Project](https://github.com/orgs/MojoCodeInc/projects/1) for unassigned "Good First Issues."
- For docs, visit [Mojo Code Docs](https://github.com/MojoCodeInc/Mojo-Code-Docs).

### Reporting Bugs

- Check for existing reports first.
- Create new bugs using the ["Bug Report" template](https://github.com/MojoCodeInc/Mojo-Code/issues/new/choose).
- **Security issues**: Report privately via [security advisories](https://github.com/MojoCodeInc/Mojo-Code/security/advisories/new).
...
```
git clone https://github.com/YOUR_USERNAME/Mojo-Code.git
```
...
By contributing, you agree your contributions will be licensed under the Apache 2.0 License, consistent with Mojo Code's licensing.
