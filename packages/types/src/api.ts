...
import type { MojoCodeEvents } from "./events.js"
import type { MojoCodeSettings } from "./global-settings.js"
...
export type MojoCodeAPIEvents = MojoCodeEvents

export interface MojoCodeAPI extends EventEmitter<MojoCodeAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): MojoCodeSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: MojoCodeSettings): Promise<void>
	/**
...
export interface MojoCodeIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
