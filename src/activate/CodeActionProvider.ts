...
import { CodeActionName, CodeActionId } from "@Mojo-code/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Mojo Code",
	FIX: "Fix with Mojo Code",
	IMPROVE: "Improve with Mojo Code",
	ADD_TO_CONTEXT: "Add to Mojo Code",
	NEW_TASK: "New Mojo Code Task",
} as const
