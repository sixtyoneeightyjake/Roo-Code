...
>>>>>>> REPLACE`
		...
		it("should match content with smart quotes", async () => {
			const originalContent =
				"**Enjoy Mojo Code!** Whether you keep it on a short leash or let it roam autonomously, we can't wait to see what you build. If you have questions or feature ideas, drop by our [Reddit community](https://www.reddit.com/r/MojoCode/) or [Discord](https://discord.gg/Mojocode). Happy coding!"
			const diffContent = `test.ts
<<<<<<< SEARCH
**Enjoy Mojo Code!** Whether you keep it on a short leash or let it roam autonomously, we can't wait to see what you build. If you have questions or feature ideas, drop by our [Reddit community](https://www.reddit.com/r/MojoCode/) or [Discord](https://discord.gg/Mojocode). Happy coding!
=======
