// npx vitest core/ignore/__tests__/MojoIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { MojoIgnoreController } from "../RooIgnoreController"
...
describe("MojoIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .Mojoignore to exist with some patterns
