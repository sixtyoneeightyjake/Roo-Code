...
const initWorkspaceRepo = async ({
	workspaceDir,
	userName = "Mojo Code",
	userEmail = "support@Mojocode.com",
	...
	(klass, prefix) => {
		...
		describe(`${klass.name}#hasNestedGitRepositories`, () => {
			it("throws error when nested git repositories are detected during initialization", async () => {
				...
				await mainGit.init()
				await mainGit.addConfig("user.name", "Mojo Code")
				await mainGit.addConfig("user.email", "support@Mojocode.com")
				...
				await nestedGit.addConfig("user.name", "Mojo Code")
				await nestedGit.addConfig("user.email", "support@Mojocode.com")
