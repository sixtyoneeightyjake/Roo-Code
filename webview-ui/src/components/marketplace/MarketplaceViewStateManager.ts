 ...
 *
 * This class manages the state for the marketplace view in the Mojo Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Mojo Code extensions interface
