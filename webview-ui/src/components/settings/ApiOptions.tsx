...
import { Anthropic, Gemini, OpenAI } from "./providers"
...
const ApiOptions = ({
	...
	useDebounce(
		() => {
			// No dynamic model fetching needed for anthropic, openai-native, and gemini
			// as they use predefined model lists
		},
		250,
		[selectedProvider],
	)
